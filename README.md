...
My solutions to some of the elm challenges (<https://github.com/pdamoc/elmChallenges>) while trying to learn Elm.
...
The program will print "Right" in the middle of the screen if the mouse cursor is on the right half of the screen or will print "Left" instead in middle of the screen if the mouse cursor in on the left half of the screen.
